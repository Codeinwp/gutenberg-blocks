...
const { Button, ButtonGroup, PanelBody, RangeControl } = wp.components;
	...
	return (
		<Fragment>
			...
			<PanelBody title={__('Color')} initialOpen={false}>
				...
				{hover ? (
					<Fragment>
						<ColorBaseControl label={'Hover Background'} colorValue={defaults.backgroundColorHover}>
							<ColorPalette
						...
						<ColorBaseControl label={'Hover Icon'} colorValue={defaults.textColorHover}>
							<ColorPalette
								label={'Hover Icon'}
					...
					<Fragment>
						<ColorBaseControl label={'Background'} colorValue={defaults.backgroundColor}>
							<ColorPalette
								label={'Background'}
						...
						<ColorBaseControl label={'Icon'} colorValue={defaults.textColor}>
							<ColorPalette
								label={'Icon'}
