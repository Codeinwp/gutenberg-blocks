...
const Edit = ({ attributes, setAttributes, className, name, clientId }) => {
	...
	return (
		<Fragment>
			...
			<div
				id={attributes.id}
				className={classnames(className, 'wp-block-buttons', {
					[`align-${attributes.align}`]: attributes.align,
					collapse:
						('collapse-desktop' === attributes.collapse && (isDesktop || isTablet || isMobile)) ||
						('collapse-tablet' === attributes.collapse && (isTablet || isMobile)) ||
						('collapse-mobile' === attributes.collapse && isMobile),
				})}
			>
				<InnerBlocks
