...
const Inspector = ({ attributes, setAttributes, onHeightChange, heightMode, setHeightMode }) => {
	...
	return (
		<InspectorControls>
			<PanelBody title={__('Settings')}>
				<TextControl label={__('Title')} value={attributes.title} onChange={onTitleChange} />
