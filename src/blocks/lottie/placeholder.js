...
const BlockPlaceholder = ({ className, file, onChange }) => {
	useEffect(() => {
	...
	return (
		<Fragment>
			...
			{isOpen && (
				...
				>
					{__(
						'This file type is not permitted for security reasons. Would you still like to enable JSON uploads?'
					)}
					<br />
					<br />
					<ExternalLink href={window.themeisleGutenberg.optionsPath}>
						{__('You can enable JSON uploads from Otter.')}
					</ExternalLink>
					<br />
					<br />
