...
const { Button, Path, Rect, SVG, Tooltip } = wp.components;
...
const LayoutControl = ({ label, onClick, layout, layoutTablet, layoutMobile, columns }) => {
	...
	return (
		<ResponsiveControl label={label} className="wp-block-themeisle-blocks-advanced-columns-layout-control">
			{(1 === columns && (
				<Tooltip text={__('Single Row')}>
					<Button
						className={classnames('wp-block-themeisle-blocks-advanced-column-layout', {
