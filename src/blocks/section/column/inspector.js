...
const { Button, Dashicon, PanelBody, ToggleControl, RangeControl, SelectControl } = wp.components;
...
const Inspector = ({
	...
	const getMargin = (type) => {
		...
		if ('right' == type) {
			...
			if ('Tablet' === getView) {
				value =
					'linked' === attributes.marginTypeTablet ? attributes.marginTablet : attributes.marginRightTablet;
			}

			if ('Mobile' === getView) {
				value =
					'linked' === attributes.marginTypeMobile ? attributes.marginMobile : attributes.marginRightMobile;
			}
		}
		...
		if ('left' == type) {
			...
			if ('Tablet' === getView) {
				value =
					'linked' === attributes.marginTypeTablet ? attributes.marginTablet : attributes.marginLeftTablet;
			}

			if ('Mobile' === getView) {
				value =
					'linked' === attributes.marginTypeMobile ? attributes.marginMobile : attributes.marginLeftMobile;
			}
		}
	...
	return (
		<InspectorControls>
			<PanelBody className="wp-block-themeisle-blocks-advanced-columns-header-panel">
				<Button
					className={classnames('header-tab', { 'is-selected': 'layout' === tab })}
			...
			{('layout' === tab && (
				...
				('style' === tab && (
					<Fragment>
						<PanelBody title={__('Background Settings')} className="wp-block-themeisle-image-container">
							<BackgroundControl
							...
							{('color' === attributes.backgroundType && (
								<ColorBaseControl label={__('Background Color')} colorValue={attributes.headingColor}>
									<ColorPalette
						...
						>
							...
							<ColorBaseControl label={__('Border Color')} colorValue={attributes.borderColor}>
								<ColorPalette
									label={'Border Color'}
							...
							{attributes.boxShadow && (
								<Fragment>
									<ColorBaseControl label={__('Shadow Color')} colorValue={attributes.boxShadowColor}>
										<ColorPalette
											label={'Shadow Color'}
