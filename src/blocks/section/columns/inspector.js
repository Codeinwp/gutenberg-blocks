...
const Inspector = ({ attributes, setAttributes, updateColumnsWidth, dividerViewType, setDividerViewType }) => {
					...
					('style' === tab && (
						<Fragment>
							...
							>
								...
								<ControlPanelControl label={'CSS Filters'}>
									<RangeControl
										label={__('Blur')}
							...
							>
								...
								{attributes.boxShadow && (
									<Fragment>
										...
										<ControlPanelControl label={'Border Shadow'}>
											<RangeControl
												label={__('Opacity')}
							...
							>
								...
								{'none' !== getDividerType && (
									<Fragment>
										<ColorBaseControl label={__('Color')} colorValue={getDividerColor}>
											<ColorPalette
												label={__('Color')}
										...
										<ResponsiveControl label={'Height'}>
											<RangeControl
