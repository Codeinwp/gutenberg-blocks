...
const { Button, ExternalLink, Placeholder, Spinner, TextControl } = wp.components;

const BlockPlaceholder = ({ className, api, isAPILoaded, isAPISaved, isSaving, changeAPI, saveAPIKey }) => {
	if (!isAPILoaded) {
		return (
			<Placeholder>
				<Spinner />
			...
			>
				...
				<div className="components-placeholder__learn-more">
					...
					<ExternalLink href="https://developers.google.com/maps/documentation/javascript/get-api-key">
						{__('Need an API key? Get one here.')}
					</ExternalLink>
				</div>
			</Placeholder>
		);
