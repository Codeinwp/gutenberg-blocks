...
const { BaseControl, Button, ExternalLink, SelectControl, TextControl } = wp.components;
...
const Marker = ({ marker, isOpen, isPlaceAPIAvailable, openMarker, removeMarker, changeMarkerProp }) => {
	...
	return (
		<div className="wp-block-themeisle-blocks-google-map-marker">
			...
			<div
				className={classnames('wp-block-themeisle-blocks-google-map-marker-control-area', {
