...
const Inspector = ({ attributes, setAttributes, slider, changePerView, onSelectImages }) => {
						...
						{1 < attributes.perView && (
							<Fragment>
								...
								<RangeControl
									label={__('Peek')}
									help={__(
										'The value of the future slides which have to be visible in the current slide.'
									)}
