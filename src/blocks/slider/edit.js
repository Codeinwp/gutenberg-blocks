	...
	return (
		<Fragment>
			...
			<ResizableBox
				...
				className={classnames('wp-block-themeisle-blocks-slider-resizer', { 'is-focused': isSelected })}
			>
				<div id={attributes.id} className={classnames('wp-block-themeisle-blocks-slider', 'glide', className)}>
