...
import { closeSmall, chevronLeft, chevronRight, Icon } from '@wordpress/icons';
...
const Slide = ({ images, image, index, isFirstItem, isLastItem, isSelected, setAttributes, setSelectedImage }) => {
	...
	return (
		<div
			className={classnames('wp-block-themeisle-blocks-slider-item-wrapper glide__slide', {
