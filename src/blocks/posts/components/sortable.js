...
const { Button, TextControl, SelectControl, ToggleControl } = wp.components;
...
export const SortableItem = ({ value, disabled, getFields, toggleFields, imageSize, titleTag, excerptLimit }) => {
	...
	return (
		...
		>
			<div
				className={classnames('wp-block-themeisle-blocks-posts-grid-builder-item', {
					disabled: disabled,
			...
			>
				...
				<div className="wp-block-themeisle-blocks-posts-grid-builder-label">{label}</div>
			...
			{edit && (
				<div
					className={classnames('wp-block-themeisle-blocks-posts-grid-builder-control-area', {
...
export const SortableList = SortableContainer(({ template, getFields, toggleFields, titleTag, excerptLimit }) => {
	return (
		<div>
