...
const { PanelBody, QueryControls, RangeControl, TextControl } = wp.components;
...
const Inspector = ({ attributes, setAttributes, changeStyle, categoriesList }) => {
	...
	const selectedCategoryId =
		'object' === typeof attributes.categories
			? 1 <= attributes.categories.length
				? attributes.categories[0].id
				: undefined
	...
	return (
		<InspectorControls>
			...
			<PanelBody title={__('Design & Layout')} initialOpen={false}>
				<LayoutBuilder
