...
const SizingControl = ({ label, type, min, max, changeType, options, onChange }) => {
	...
	return (
		<div id={id} className="wp-block-themeisle-blocks-sizing-control">
			<div className="components-base-control__field">
				...
				<div className={classnames('wp-block-themeisle-blocks-sizing-control-wrapper', { linking: type })}>
					{options.map((i, n) => (
						<Field id={instanceId} index={i} option={n} min={min} max={max} onChange={onChange} />
					))}

					{type && (
						<div
							className={classnames('wp-block-themeisle-blocks-sizing-control-item', 'toggle-linking', {
