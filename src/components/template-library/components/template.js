				...
				<LazyLoad>
					<img
						src={
							...
							'https://raw.githubusercontent.com/Codeinwp/gutenberg-templates/master/assets/images/default.jpg'
						}
					/>
				</LazyLoad>
			</div>
			...
			<div className="library-modal-content__footer">
				<div className="library-modal-content__footer_meta">
					<h4 className="library-modal-content__footer_meta_area">
						{template.title && template.title + (template.author && __(' by ') + template.author)}

						{!template.title && template.author && __('Author: ') + template.author}
					</h4>
				</div>
