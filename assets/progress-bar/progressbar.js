( function( f ) {
		...
		! ( function( t, n ) {
			...
			return ( function( t ) {
				var n = {};function e( r ) {
					if ( n[r]) {
						return n[r].exports;
					} var i = n[r] = {i: r, l: ! 1, exports: {}};return t[r].call( i.exports, i, i.exports, e ), i.l = ! 0, i.exports;
					...
					if ( 1 & n && ( t = e( t ) ), 8 & n ) {
						...
						return t;
					} var r = Object.create( null );if ( e.r( r ), Object.defineProperty( r, 'default', {enumerable: ! 0, value: t}), 2 & n && 'string' != typeof t ) {
						for ( var i in t ) {
							e.d( r, i, function( n ) {
								return t[n];
							}.bind( null, i ) );
				...
				'use strict';( function( t ) {
					e.d( n, 'e', ( function() {
						...
						for ( var n = 1;n < arguments.length;n++ ) {
							var e = null != arguments[n] ? arguments[n] : {};n % 2 ? o( Object( e ), ! 0 ).forEach( ( function( n ) {
								c( t, n, e[n]);
						...
						v = function( t, n, e, r, i, u, o ) {
							var a = t < u ? 0 : ( t - u ) / i;for ( var c in n ) {
								var f = o[c],
									s = f.call ? f : d[f],
									l = e[c];n[c] = l + ( r[c] - l ) * s( a );
							} return n;
						},
						y = function( t, n ) {
							var e = t._attachment,
								...
								l = s + i + a,
								h = n > l ? l : n,
								p = a - ( l - h );h >= l ? ( c( f, e, p ), t.stop( ! 0 ) ) : ( t._applyFilter( 'beforeTween' ), h < s + i ? ( h = 1, a = 1, s = 1 ) : s += i, v( h, r, o, f, a, s, u ), t._applyFilter( 'afterTween' ), c( r, e, p ) );
						},
						_ = function() {
							for ( var t = b.now(), n = h;n; ) {
								var e = n._next;y( n, t ), n = e;
							}
						},
						m = function( t ) {
							var n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 'linear',
								e = {},
								r = u( n );if ( 'string' === r || 'function' === r ) {
								for ( var i in t ) {
									e[i] = n;
								}
							} else {
						...
						g = function( t ) {
							if ( t === h ) {
								...
								var n = t._previous,
									e = t._next;n._next = e, e._previous = n;
							}t._previous = t._next = null;
						},
						b = ( function() {
							function t() {
								var n = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
									e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : void 0;! ( function( t, n ) {
									if ( ! ( t instanceof n ) ) {
							...
							} var n, e, r;return n = t, ( e = [ {key: '_applyFilter', value: function( t ) {
								var n = ! 0,
									e = ! 1,
									r = void 0;try {
									for ( var i, u = this._filters[Symbol.iterator]();! ( n = ( i = u.next() ).done );n = ! 0 ) {
										var o = i.value[t];o && o( this );
									}
								} catch ( t ) {
									e = ! 0, r = t;
								} finally {
								...
								var n = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : void 0,
									e = this._attachment,
									r = this._configured;return ! n && r || this.setConfig( n ), this._pausedAtTime = null, this._timestamp = t.now(), this._start( this.get(), e ), this.resume();
								...
								} var n = t.now();return this._pausedAtTime && ( this._timestamp += n - this._pausedAtTime, this._pausedAtTime = null ), this._isPlaying = ! 0, null === h ? ( h = this, p = this, ( function t() {
									h && ( s.call( f, t, 1e3 / 60 ), _() );
								}() ) ) : ( this._previous = p, p._next = this, p = this ), this._promise;
							}}, {key: 'seek', value: function( n ) {
								n = Math.max( n, 0 );var e = t.now();return 0 === this._timestamp + n ? this : ( this._timestamp = e - n, this._isPlaying || y( this, e ), this );
								...
								var t = 0 < arguments.length && void 0 !== arguments[0] && arguments[0],
									...
									u = this._targetState;if ( this._isPlaying ) {
									return this._isPlaying = ! 1, g( this ), t ? ( this._applyFilter( 'beforeTween' ), v( 1, e, i, u, 1, 0, r ), this._applyFilter( 'afterTween' ), this._applyFilter( 'afterTweenEnd' ), this._resolve( e, n ) ) : this._reject( e, n ), this;
								}
						...
						var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
							n = new b,
							e = n.tween( t );return e.tweenable = n, e;
				...
				'use strict';e.r( n ), e.d( n, 'linear', ( function() {
					return r;
     ...
     */
				var r = function( t ) {
					...
					w = function( t ) {
						return 0 === t ? 0 : 1 === t ? 1 : 1 > ( t /= .5 ) ? .5 * Math.pow( 2, 10 * ( t - 1 ) ) : .5 * ( 2 - Math.pow( 2, -10 * --t ) );
					},
					O = function( t ) {
					...
					x = function( t ) {
						var n = 1.70158;return 1 > ( t /= .5 ) ? t * t * ( ( 1 + ( n *= 1.525 ) ) * t - n ) * .5 : .5 * ( ( t -= 2 ) * t * ( ( 1 + ( n *= 1.525 ) ) * t + n ) + 2 );
					},
					T = function( t ) {
				...
				'use strict';e.r( n );var r = {};e.r( r ), e.d( r, 'doesApply', ( function() {
					return x;
					...
					_ = function( t ) {
						for ( var n in t ) {
							var e = t[n];'string' == typeof e && e.match( h ) && ( t[n] = y( h, e, v ) );
						}
					},
					m = function( t ) {
					...
					M = function( t, n ) {
						for ( var e in n ) {
							var r = n[e],
								i = r.chunkNames,
								u = r.formatString,
								o = j( u, S( O( t, i ), i ) );t[e] = y( s, o, m );
						}
					},
					k = function( t, n ) {
						var e = function( e ) {
							var r = n[e].chunkNames,
								i = t[e];if ( 'string' == typeof i ) {
								var u = i.split( ' ' ),
					...
					x = function( t ) {
						var n = t._currentState;return Object.keys( n ).some( ( function( t ) {
							return 'string' == typeof n[t];
						}) );
					};function T( t ) {
					var n = t._currentState;[ n, t._originalState, t._targetState ].forEach( _ ), t._tokenData = b( n );
				} function E( t ) {
					var n = t._currentState,
						e = t._originalState,
						r = t._targetState,
						i = t._easing,
						u = t._tokenData;k( i, u ), [ n, e, r ].forEach( ( function( t ) {
						return w( t, u );
					}) );
				} function F( t ) {
					var n = t._currentState,
					...
					Q = function( t, n, e, r ) {
						var i = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : 0,
							u = I({}, t ),
							a = Object( o.b )( t, r );for ( var c in D._filters.length = 0, D.set({}), D._currentState = u, D._originalState = t, D._targetState = n, D._easing = a, q ) {
							q[c].doesApply( D ) && D._filters.push( q[c]);
						}D._applyFilter( 'tweenCreated' ), D._applyFilter( 'beforeTween' );var f = Object( o.e )( e, u, t, n, 1, i, a );return D._applyFilter( 'afterTween' ), f;
					};function B( t ) {
					return ( function( t ) {
						if ( Array.isArray( t ) ) {
					...
					var e = n.get( t );if ( ! e ) {
						...
						function t() {
							...
							}( this, t ) ), L.set( this, {writable: ! 0, value: []});for ( var n = arguments.length, e = new Array( n ), r = 0;r < n;r++ ) {
								e[r] = arguments[r];
							}e.forEach( this.add.bind( this ) );
						} var n, e, r;return n = t, ( e = [ {key: 'add', value: function( t ) {
							return R( this, L ).push( t ), t;
						}}, {key: 'remove', value: function( t ) {
							var n = R( this, L ).indexOf( t );return ~n && R( this, L ).splice( n, 1 ), t;
					...
					L = new WeakMap;function V( t, n, e, r, i, u ) {
					var o, a,
						c = 0,
						f = 0,
						s = 0,
						...
						var e, r, i, u, o, a;for ( i = t, a = 0;8 > a;a++ ) {
							if ( u = d( i ) - t, y( u ) < n ) {
								return i;
							} if ( o = v( i ), 1e-6 > y( o ) ) {
								break;
		...
		function setStyles( element, styles ) {
			forEachObject( styles, function( styleValue, styleName ) {
				...
				if ( null === styleValue || styleValue === undefined ) {
					return;
				}

				// If style's value is {prefix: true, value: '50%'},
				// Set also browser prefixed styles
				if ( isObject( styleValue ) && true === styleValue.prefix ) {
