...
class Countdown_CSS extends Base_CSS {
	...
	public function render_css( $block ) {
		...
		$css->add_item(
			array(
				'selector'   => ' .ti-countdown__container .ti-countdown__display .ti-countdown__display-area.is-main-component',
				'properties' => array(
					array(
		...
		$css->add_item(
			array(
				'query'      => '@media ( min-width: 961px )',
				'selector'   => ' .ti-countdown__container .ti-countdown__display .ti-countdown__display-area',
				'properties' => array(
					array(
						'property' => 'height',
						'value'    => 'height',
		...
		$css->add_item(
			array(
				'query'      => '@media ( min-width: 961px )',
				'selector'   => ' .ti-countdown__container .ti-countdown__display',
				'properties' => array(
					array(
						'property' => 'gap',
						'value'    => 'gap',
		...
		$css->add_item(
			array(
				'selector'   => ' .ti-countdown__container .ti-countdown__display .ti-countdown__display-area .ti-countdown__value',
				'properties' => array(
					array(
						'property' => 'color',
						'value'    => 'valueColor',
		...
		$css->add_item(
			array(
				'selector'   => ' .ti-countdown__container .ti-countdown__display .ti-countdown__display-area .ti-countdown__label',
				'properties' => array(
					array(
						'property' => 'color',
						'value'    => 'labelColor',
